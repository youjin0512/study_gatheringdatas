...
browser.get("https://www.jobplanet.co.kr/users/sign_in?_nav=gb")    # 로그인 주소 입력, 브라우저에 링크 넣고 엔터까지 친게 get의 기능
...
element_user_email = browser.find_element(by=By.CSS_SELECTOR, value="#user_email")  #webelement의 element_user_email (class)가 된다. 
element_user_email.send_keys("kelly.youjin.kim@gmail.com")

element_user_password = browser.find_element(by=By.CSS_SELECTOR, value="#user_password")
element_user_password.send_keys("")   # 평소에는 * 사용하지 않고 직접 넣기
